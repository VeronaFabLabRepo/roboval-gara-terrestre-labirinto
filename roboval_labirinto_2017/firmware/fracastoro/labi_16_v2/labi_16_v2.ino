...
#define STEERING_SPEED         MAX_SPEED*.5 
...
void forward() {
  ...
  integral += proportional;
	...
	std_speed = MAX_SPEED - (K_LINEAR * constrain(abs(correction), 0, 250));
...
void turn_left() {
	//Turn right until is on the line.
	if (digi_sensors & B100000)
		jump(-STEERING_SPEED, STEERING_SPEED, &turn_left_end);
}
void turn_left_end() {
	//Turn right until is on the line.
