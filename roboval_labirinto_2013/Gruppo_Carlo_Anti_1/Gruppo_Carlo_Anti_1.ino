...
/*
* @author: Gruppo Carlo Anti 1
 *
 * Roboval 2013
 * Firmware base per il robot
...
#define correction_speed    0// velocita' di correzione traiettoria rettilinea (0-100)
...
#define soglia             220 // soglia di riconoscimento bianco/nero (0-1000)
