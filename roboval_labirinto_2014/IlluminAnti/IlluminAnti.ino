...
#define correction_speed    13 // velocita' di correzione traiettoria rettilinea (0-100)
#define turn_speed          13 // velocita' di curvatura (0-100)
#define debugPeriod        400 // ogni quanti millisecondi inviare i messaggi di debug
#define soglia             230 // soglia di riconoscimento bianco/nero (0-1000)
#define attesaPerManovra    40 // tempo di attesa tra il riconoscimento della curva e il comando ai motori
