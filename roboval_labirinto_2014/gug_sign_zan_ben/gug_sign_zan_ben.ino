...
#define correction_speed    31  // velocita' di correzione traiettoria rettilinea (0-100)
#define turn_speed          20 // velocita' di curvatura (0-100)
#define debugPeriod        950// ogni quanti millisecondi inviare i messaggi di debug
#define soglia             200 // soglia di riconoscimento bianco/nero (0-1000)
#define attesaPerManovra    65 // tempo di attesa tra il riconoscimento della curva e il comando ai motori
...
void straight(){
   if(rightCenterReading){// 0x10x0 il robot e' troppo a destra, deve andare piu' a sinistra quindi alzo il motore destro
