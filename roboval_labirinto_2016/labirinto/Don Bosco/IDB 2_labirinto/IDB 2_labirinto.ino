...
/*
* @author: Federico Vicentini, Riccardo Menini, Alberto Saretto
 *
 * Roboval \
...
#define correction_speed     6 // velocita' di correzione traiettoria rettilinea (0-100)   
#define turn_speed          21 // velocita' di curvatura (0-100)                          
#define debugPeriod        700 // ogni quanti millisecondi inviare i messaggi di debug
#define soglia             200 // soglia di riconoscimento bianco/nero (0-1000)
#define attesaPerManovra    15 // tempo di attesa tra il riconoscimento della curva e il comando ai motori
#define disumana            72 // velocità massima
...
void straight(){
  if(!leftNearReading){// 0x01x0 il robot e' troppo a sinistra, deve andare piu' a destra quindi alzo il motore sinistro
    ...
    set_motor(right_motor, disumana); // ATTENZIONE!!! modificato con il +10
    set_motor(left_motor, disumana); // idem come sopra
  }
}
