...
//
#define full_speed 36 // velocita' massima (0-100)
#define correction_speed 20 // velocita' di correzione traiettoria rettilinea (0-100)
...
#define attesaPerManovra 70 // tempo di attesa tra il riconoscimento della curva e il comando ai motori
