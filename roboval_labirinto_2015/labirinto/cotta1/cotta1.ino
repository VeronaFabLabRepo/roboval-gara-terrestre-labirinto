...
#define full_speed          22 // velocita' massima (0-100)
#define correction_speed    12 // velocita' di correzione traiettoria rettilinea (0-100)
#define turn_speed          25 // velocita' di curvatura (0-100)
#define motor_out            0 // fermo la/e ruote
...
void turnLeft(){
  ...
  while(!leftNearReading || !rightNearReading){
    set_motor(left_motor,-turn_speed-5);
