...
#define full_speed          55 //velocita massima
#define outline_speed    60    //velocita quando il robot non è perfettamente sulla strada (=velocita massima -> non serve a niente :) )
#define turn_speed       30    //velocita in manovra (rotazione a destra , sinistra)
