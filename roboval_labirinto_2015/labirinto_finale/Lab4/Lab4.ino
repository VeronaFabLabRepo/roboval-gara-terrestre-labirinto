...
#define full_speed          60 //velocita massima
#define outline_speed    65//velocita quando il robot non è perfettamente sulla strada (=velocita massima -> non serve a niente :) )
